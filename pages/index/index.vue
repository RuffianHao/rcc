<template>
	<view class="index-container container ">
		...
		<!-- 通知 -->
		<u-notice-bar @close="noticeBarShow=false" :show="noticeBarShow" :close-icon="true" type="primary" mode="horizontal" :list="noticeList"></u-notice-bar>
		<!-- 图标导航 --> 
		...
		<view class="tab-wrap">
			<u-tabs
				...
				active-color="#000"
				:bar-width="120"
				:bar-style="{ backgroundColor: '#02D4D3', height: '4rpx' }"
				name="cate_name"
				count="cate_count"
				:list="tabsList"
				:is-scroll="false"
		...
		<u-card
			:show-foot="false"
			class="features-specialty"
			:title-size="'34rpx'"
			:head-style="{ fontSize: '34rpx', fontWeight: '600' }"
		...
		<view class="college-theme">
			<view class="title"><view style="font-size: 34rpx;padding: 0 0 20rpx 20rpx;font-weight: 600;">大学院主题介绍</view></view>
		...
		<custom-tabbar :value="0"></custom-tabbar>
	</view>
</template>
