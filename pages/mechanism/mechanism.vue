<template>
	<view class="container">
		<!-- 头部区域 -->
		<SearchSwiper title :list="swiperList" height="480" @click="handleClick"></SearchSwiper>
		<!-- 机构 -->
		<view class="">
			<u-cell-group>
				<u-cell-item :arrow="false" title="九段日本文化研究所日本語学院">
					<view slot="label"><view>〒101-0061 东京都千代田区神田三崎町2-7-10帝都三崎町大楼1F</view></view>
				</u-cell-item>
				<u-cell-item :arrow="false" title="九段日本文化研究所日本語学院">
					<view slot="label"><view>〒101-0061 东京都千代田区神田三崎町2-7-10帝都三崎町大楼1F</view></view>
				</u-cell-item>
		...
		<custom-tabbar :value="3"></custom-tabbar>
	</view>
</template>
